...
public class SaxExcelReader<T> {
    ...
    private void process(OPCPackage xlsxPackage) throws IOException, OpenXML4JException, SAXException {
        ...
        StringEhCache stringEhCache = new StringEhCache();
        try {
            XSSFReadOnlySharedStringsTable strings = new XSSFReadOnlySharedStringsTable(xlsxPackage, stringEhCache);
